...
def extract_bundle_graph():
    ...
    for root, _, files in os.walk(bundle_dir):
        for f in sorted(files):
            ...
            c_verified = m_verified.group(1).strip() if m_verified else "human:leszekw"
...
def generate_static_svg(nodes, edges, output_path):
    ...
    svg_lines = [
        ...
        '</defs>',
        '<!-- Title & Legend -->',
        '<text x="40" y="45" fill="#38bdf8" font-size="22" font-weight="700">Google OKF v0.2 Knowledge Architecture &amp; Progressive Disclosure Graph</text>',
